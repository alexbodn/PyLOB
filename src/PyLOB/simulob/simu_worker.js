...
'use strict';
		...
		*/
		...
		//TODO REMOVE this
		require(new URL('./strategies/peakswinger.js', self.location.href).toString());
		let driver = require(new URL('../worker.js', self.location.href).toString());
		...
		self.sqlite3InitModule({
			...
			try {
				...
				self.performer = new RemotePerformer(driver);
